...
function generateLangOptions(translationApi: "google"): ILangOption[] {
...
function alphabeticallySort(a: ILangOption, b: ILangOption) {
  return a.name.localeCompare(b.name);
}

export default generateLangOptions;
